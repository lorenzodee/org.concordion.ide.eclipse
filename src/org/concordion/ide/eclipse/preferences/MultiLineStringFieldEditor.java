 ...
 * </p>
 * A copy of {@link StringFieldEditor} as overriding {@link #getTextControl()}
 * is not sufficient because textField is a member with package visibility
 * and cannot be set to <code>null</code> in a dispose listener. 
 */
